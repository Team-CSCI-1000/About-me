    ...
    <div className='container'>
      ...
      <main>
        ...
        <div className='grid'>
          ...
          <a href='/Batman ' className='card'>
            <h3>Example Batman Page &rarr;</h3>
            <p>Click here to navigate to the Batman page</p>
          </a>
          <a href='/JasonFelix ' className='card'>
            <h3>Jason's Page &rarr;</h3>
            <p>Click here ...</p>
          </a>
